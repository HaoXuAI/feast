...
class OnDemandFeatureView(FeatureView):
    ...
    OnDemandFeatureView inherits from FeatureView so that it can participate in the
    FeatureResolver and FeatureBuilder DAG infrastructure. It bypasses FeatureView's
    __init__ since ODFV sources are FeatureViewProjections and RequestSources rather
    than DataSources.
    ...
    def __init__(  # noqa: C901
        ...
        *,
        ...
        """
        # Call BaseFeatureView.__init__ directly, bypassing FeatureView.__init__
        # which requires a DataSource. ODFV sources are FeatureViewProjections and
        # RequestSources, not DataSources.
        BaseFeatureView.__init__(
            self,
            name=name,
            features=schema,
        ...
        # Set FeatureView-compatible attributes so ODFV can participate in the
        # FeatureResolver/FeatureBuilder DAG infrastructure.
        self.batch_source = None  # type: ignore[assignment]
